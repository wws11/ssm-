package com.soecode.lyf.demo.datastruct.arraylist;
        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    /**
     * 一个空数组实例
     * 当一个用户没有指定ArrayList的容量时（即调用无参构造函数），返回的是该数组==》刚创建一个ArrayList时，其内部数据量为0
     * 当用户第一次添加元素时，该数组将会扩容，变成默认容量为10的DEFAULT_CAPACITY的一个数组，通过ensureCapacityInternal()实现
